...
// Copyright (c) 2011-2013 diaoyudaocoin Developers.
...
uint256 hashGenesisBlock("0x085c749ecc198b28a0782e9ef8a8612940e967b872cbdb63c11702879e7d0369");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // diaoyudaocoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "diaoyudaocoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 262800 blocks, which will occur approximately every 3 years
    nSubsidy >>= (nHeight / 262800);

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // diaoyudaocoin:
static const int64 nTargetSpacing = 120; // diaoyudaocoin: 120 seconds
...
// Diaoyudaocoin difficulty adjustment protocol switch
   ...
   int64 nInterval = fInflationFixProtocol? (nTargetTimespanCurrent / nTargetSpacing) : (nTargetTimespanCurrent / (nTargetSpacing / 2));
    ...
    // diaoyudaocoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal diaoyudaocoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "diaoyudaocoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x71b6a612cf7508cea2ff865b80f21cbb3d9cfd325f6ced16ae4e16ce20377b31");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Diaoyudaocoin, Island pride coin!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1390712261;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2061948;

        if (fTestNet)
        {
            block.nTime    = 1390707615;             //test net is supported
            block.nNonce   = 1753344;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x94638b48be65adfb5c7eb05d838cd67f16968a5325f67601f2402411c575d169"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // diaoyudaocoin: increase each by adding 2 to bitcoin's value.
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // diaoyudaocoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
